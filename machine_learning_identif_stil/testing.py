...
# Paths to test data
test_dir = 'C:\\Users\\radit\\source\\repos\\Proiect\\machine_learning_identif_stil\\test_set2'
...
model = load_model('trained_model_final.h5')
# model = load_model('trained_model_final2.h5')
